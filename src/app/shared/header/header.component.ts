...
export class HeaderComponent implements OnInit {
  ...
  constructor(private tokenStorage:TokenStorage,private router:Router, private usuarioService:UsuarioService) { }
